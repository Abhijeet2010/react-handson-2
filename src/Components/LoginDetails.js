      ...
      {newRecord.map((currElem) => {
        return (
          <div className="show__data">
            <p><b>Username :</b> <br/> {currElem.username}</p>
            <p><b>Password :</b><br/> {currElem.password}</p>
            <p> <b>Email :</b> <br/> {currElem.email}</p>
            <p><b>Location :</b><br/>  {currElem.location}</p>
            <p> <b>Phone Number :</b><br/>  {currElem.phone}</p>
          </div>
        );
      })}
    </div>
